...
const Home = () => {
    const [imgSt, setImgSt] = useState(["src/images/05.jpeg", "src/images/06.jpeg", "src/images/07.jpeg"]);
    ...
    return (
        <div ref={mainContainer} className="relative min-h-screen overflow-x-hidden bg-[#030712] text-white font-sans selection:bg-blue-500/30">
            ...
            <div className="relative h-[85vh] flex items-center justify-center perspective-[2000px] z-10 pt-10">
                <div className="flex items-center justify-center gap-2 md:gap-8 transform-style-3d">
                    ...
                    <div className="morque relative h-[300px] w-[220px] md:h-[400px] md:w-[300px] rounded-[2rem] overflow-hidden transition-all duration-1000 ease-in-out shadow-2xl border border-white/5"
                        style={{ transform: "rotateY(35deg) translateZ(-150px) translateX(40px)", filter: "brightness(0.3) blur(2px)" }}>
                        <img className="h-full w-full object-cover" src={imgSt[0]} alt="Drilling 1" />
                        <div className="absolute inset-0 bg-gradient-to-r from-[#030712]/80 to-transparent" />
                    </div>

                    <div className="morque relative z-20 h-[450px] w-[320px] md:h-[600px] md:w-[450px] rounded-[2.5rem] overflow-hidden transition-all duration-1000 ease-in-out shadow-[0_0_80px_rgba(37,99,235,0.2)] border border-white/10 ring-1 ring-blue-500/20"
                        style={{ transform: "translateZ(50px)" }}>
                        <img className="h-full w-full object-cover scale-105 duration-1000 ease-out" src={imgSt[1]} alt="Core Service" />
                        ...
                        <div className="absolute bottom-0 inset-x-0 p-8 flex flex-col justify-end transform translate-y-0">
                            <div className="flex items-center gap-2 mb-3 opacity-90">
                                ...
                                <p className="text-blue-400 font-semibold tracking-[0.2em] text-xs uppercase">Core Service</p>
                            </div>
                            <h2 className="text-4xl md:text-5xl font-black text-white drop-shadow-lg">Deep Rock <br /> Drilling</h2>
                        </div>
                    </div>

                    <div className="morque relative h-[300px] w-[220px] md:h-[400px] md:w-[300px] rounded-[2rem] overflow-hidden transition-all duration-1000 ease-in-out shadow-2xl border border-white/5"
                        style={{ transform: "rotateY(-35deg) translateZ(-150px) translateX(-40px)", filter: "brightness(0.3) blur(2px)" }}>
                        <img className="h-full w-full object-cover" src={imgSt[2]} alt="Drilling 2" />
            ...
            <div className="relative z-20 max-w-7xl mx-auto flex flex-col lg:flex-row justify-between items-center gap-16 px-6 py-24 pb-32" id="secPage">
                ...
                <div className="firstDiv flex-1 space-y-8">
                    <div className="inline-flex items-center px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 backdrop-blur-md">
                        ...
                        <span className="text-blue-300 text-sm font-semibold tracking-wide">Certified Drilling Experts</span>
                    </div>

                    <h1 className="text-5xl md:text-7xl font-black leading-[1.1] tracking-tight text-white">
                        Pure Water <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-cyan-300 to-blue-500">Starts Here.</span>
                    </h1>

                    <p className="text-gray-400 text-lg md:text-xl leading-relaxed max-w-lg font-light">
                        We combine heavy-duty machinery with precision engineering to ensure your borewell delivers crystal-clear water for generations.
                    </p>

                    <div className="flex items-center gap-12 pt-6">
                        <div className="flex flex-col group">
                            <span className="text-4xl font-black text-white group-hover:text-blue-400 transition-colors">500+</span>
                            <span className="text-gray-500 text-sm uppercase tracking-wider font-semibold mt-1">Projects</span>
                        </div>
                        <div className="w-[1px] h-14 bg-gradient-to-b from-transparent via-white/20 to-transparent" />
                        <div className="flex flex-col group">
                            <span className="text-4xl font-black text-white group-hover:text-cyan-400 transition-colors">15+</span>
                            <span className="text-gray-500 text-sm uppercase tracking-wider font-semibold mt-1">Years Exp.</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="secondDiv w-full max-w-md relative">
                    ...
                    <div className="relative bg-[#0a0a0a]/80 backdrop-blur-2xl border border-white/10 p-10 rounded-[2.5rem] shadow-[0_0_40px_rgba(0,0,0,0.5)]">
                        ...
                        <h3 className="text-2xl font-bold mb-8 text-white flex items-center gap-3">
                            <i className="ri-calculator-line text-blue-400"></i> Get Instant Quote
                        </h3>

                        <div className="space-y-6">
                            {/* Service Type */}
                            <div className="space-y-2 group/input">
                                <label className="text-xs uppercase tracking-widest text-gray-400 font-bold ml-1">Service Type</label>
                                <div className="bg-white/5 border border-white/10 p-4 rounded-2xl flex items-center justify-between hover:bg-white/10 hover:border-blue-500/30 transition-all cursor-pointer">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <span className="font-semibold text-gray-200">Borewell Drilling</span>
                                    </div>
                            ...
                            <div className="space-y-2">
                                <label className="text-xs uppercase tracking-widest text-gray-400 font-bold ml-1">Location</label>
                                <div className="relative">
                                    ...
                                    >
                                        {districts.map((d) => (
                                            <option key={d} value={d} className="bg-[#0f1117] text-gray-200 py-2">
                                                {d}
                                            </option>
                                        ))}
                                    </select>
